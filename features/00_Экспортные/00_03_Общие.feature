...
Сценарий: Я проверяю модальное окно на недостаточность прав для просмотра
	
	Если поле с именем 'ErrorInfo' существует тогда
		Тогда элемент формы с именем "ErrorInfo" стал равен шаблону "Недостаточно прав для просмотра*"
		И я нажимаю на кнопку с именем 'OK'
	Иначе
		// если это режим отладки для сбора покрытия кода
		Тогда элемент формы с именем 'Message' стал равен 'Недостаточно прав для просмотра'
		И я нажимаю на кнопку с именем 'Button0'