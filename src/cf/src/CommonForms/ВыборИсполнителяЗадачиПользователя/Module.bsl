...
Процедура ВыборРоли(ТекущиеДанные)
	...
	Если ТекущиеДанные.ИспользуетсяСОбъектамиАдресации 
		И БизнесПроцессыИЗадачиКлиентПереопределяемый.НеобходимоОпределениеОбъектовАдресацииПриВыбореРоли(ТекущиеДанные.ТипыОсновногоОбъектаАдресации,ТекущиеДанные.ТипыДополнительногоОбъектаАдресации) Тогда 
