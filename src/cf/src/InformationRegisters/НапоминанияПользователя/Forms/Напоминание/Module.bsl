...
// 
// ФОРМА ИЗМЕНЯЛАСЬ
//  * [Элементы]Форма.АвтоматическоеСохранениеДанныхВНастройках - Использовать #УведомлениеПоТелеграмВНапоминаниях
//  * [Реквизиты]Объект.УведомлятьПоТелеграм.Сохранение - Истина  #УведомлениеПоТелеграмВНапоминаниях
//  + [Элементы]УведомлятьПоТелеграм #УведомлениеПоТелеграмВНапоминаниях
//
