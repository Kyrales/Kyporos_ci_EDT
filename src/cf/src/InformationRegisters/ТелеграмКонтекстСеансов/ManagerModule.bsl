...
Процедура ИзменитьПараметрКонтекстаСеанса(Бот, ИдентификаторЧата, Параметр, Действие, Значение, ЗначениеДляКэшПараметра = "") Экспорт
	...
	Если Действие = Перечисления.ТелеграмДействияСКонтекстом.Установить Тогда
		...
		НоваяЗапись.ЗначениеДляКэшПараметра = ЗначениеДляКэшПараметра;
...
// Функция - Получить контекст сеанса
//
// Параметры:
...
//  Соответствие - состоит из:
//	  Ключ - ПланВидовХарактеристикСсылка.ТелеграмПараметрыКонтекста - параметр
//	  Свойство - Характеристика.ТелеграмПараметрыКонтекста - значение параметра
//
Функция ПолучитьКонтекстСеанса(Бот, ИдентификаторЧата) Экспорт
	...
	|	ТелеграмКонтекстСеансов.ЗначениеДляКэшПараметра КАК ЗначениеДляКэшПараметра
	|ИЗ
