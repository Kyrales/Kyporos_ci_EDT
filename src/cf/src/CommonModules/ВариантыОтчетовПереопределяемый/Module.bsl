...
//  * [Процедура]ОпределитьРазделыСВариантамиОтчетов - добавлена подсистема для отчетов: УчетЗадачПользователей 
//  * [Процедура]НастроитьВариантыОтчетов
//  * [Процедура]ОпределитьОбъектыСКомандамиОтчетов
// 
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// { *Олег Каратаев [05.07.2015]
	// УчетЗадачПользователей
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.БизнесПроцессы);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЗависшиеЗадачи);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализАктивовОрганизации);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.Задания);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.Задачи);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЗадачиИстекающиеНаДату);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЗатраченноеВремяНаЗадачи);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПросроченныеЗадачи);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПланированиеЗадачПриоритизации);
	
	// ИТАктивы
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетПоРаботеСРабочимиМестами);
	
	// УчетКонфигураций
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализВерсийКонфигураций);
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	// { *Олег Каратаев [15.03.2020]
	Объекты.Добавить(Метаданные.Документы.АктыВыполненныхРабот);
	// }
