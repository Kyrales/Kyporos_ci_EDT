...
//  * [Процедура]ПринятьЗадачуКИсполнению - обязательная установка исполнителем текущего пользователя #TaskUsers
//  * [Процедура]ОтменитьПринятиеЗадачиКИсполнению - при отмене подставлять представление исполнителя в форме #TaskUsers
// 
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Процедура ПринятьЗадачуКИсполнению(Форма, ТекущийПользователь) Экспорт
	...
	// { *Олег Каратаев [21.08.2015]
	Форма.Объект.Исполнитель = ТекущийПользователь;
	Форма.ИсполнительПредставление = ТекущийПользователь;
	// }
