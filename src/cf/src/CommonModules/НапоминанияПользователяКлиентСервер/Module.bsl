...
//  * [Функция]ОписаниеНапоминания - Дополнено УведомлятьПоТелеграм,УведомлятьПоЭлектроннойПочте #УведомлениеПоТелеграмВНапоминаниях, #УведомлениеПоЭлектроннойПочтеВНапоминаниях 
// 
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Функция ОписаниеНапоминания(ДанныеДляЗаполнения = Неопределено, ВсеРеквизиты = Ложь) Экспорт
	...
	// Дополнено УведомлятьПоТелеграм,УведомлятьПоЭлектроннойПочте #УведомлениеПоТелеграмВНапоминаниях, #УведомлениеПоЭлектроннойПочтеВНапоминаниях 
	Результат = Новый Структура("Пользователь,ВремяСобытия,Источник,СрокНапоминания,Описание,Идентификатор,НавигационнаяСсылка,
		|УведомлятьПоТелеграм,УведомлятьПоЭлектроннойПочте,ВыполненоУведомлениеПоТелеграм,ВыполненоУведомлениеПоЭлектроннойПочте ");
	//--1С--
	//Результат = Новый Структура("Пользователь,ВремяСобытия,Источник,СрокНапоминания,Описание,Идентификатор,НавигационнаяСсылка");
	// }	
