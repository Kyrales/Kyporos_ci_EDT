...
//  * [Процедура]ПолучитьПрефиксообразующиеРеквизиты - сопоставление правильной организации для Задач пользователя
// 
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Процедура ПолучитьПрефиксообразующиеРеквизиты(Объекты) Экспорт
	...
	СтрокаТаблицы.Объект = Метаданные.Задачи.ЗадачиПользователя;
	СтрокаТаблицы.Реквизит = "Проект";
	
	СтрокаТаблицы = Объекты.Добавить();
	СтрокаТаблицы.Объект = Метаданные.Документы.ПриоритизацияЗадач;
	СтрокаТаблицы.Реквизит = "Проект";
	// }	
