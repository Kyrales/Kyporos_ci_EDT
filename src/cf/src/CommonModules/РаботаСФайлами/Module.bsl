...
//  * [Функция]ДанныеФайла - получение ссылки на двоичные данные файла картинки
// 
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Функция ДанныеФайла(Знач ПрисоединенныйФайл, Знач ДополнительныеПараметры = Неопределено,
	...
	// { *Олег Каратаев [26.05.2012]
	Если ТипЗнч(ПрисоединенныйФайл)=Тип("Картинка") Тогда
		
		ИдентификаторФормы = ДополнительныеПараметры;
		
		ДвоичныеДанные = ПрисоединенныйФайл.ПолучитьДвоичныеДанные();
