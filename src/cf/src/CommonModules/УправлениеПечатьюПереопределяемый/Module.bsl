...
//  * [Процедура]ПриОпределенииОбъектовСКомандамиПечати - добавлены: ТестированиеОбъектовМетаданных, АктыВыполненныхРабот, ПриоритизацияЗадач, ЗадачиПользователя 
//  * [Процедура]ПриПолученииПодписейИПечатей - использование подписей из организации
// 
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Процедура ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати) Экспорт
	...
	Для Каждого ДокументыПоТипу Из ДокументыПоТипам Цикл
		...
		Если ТипДокумента = Тип("ДокументСсылка.АктыВыполненныхРабот") Тогда
			ОтветственныйВДокументах = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(СписокДокументов, "Ответственный");
			Для Каждого ОтветственныйВДокументе Из ОтветственныйВДокументах Цикл
				
				Документ = ОтветственныйВДокументе.Ключ;
				Ответственный = ОтветственныйВДокументе.Значение;
				Организация = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Ответственный, "Организация");
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// { *Олег Каратаев
	СписокОбъектов.Добавить(Документы.ТестированиеОбъектовМетаданных);
	СписокОбъектов.Добавить(Документы.АктыВыполненныхРабот);
	СписокОбъектов.Добавить(Документы.ПриоритизацияЗадач);
	СписокОбъектов.Добавить(Задачи.ЗадачиПользователя);
	// }	
