...
//  * [Процедура]ПриОпределенииПрефиксаИнформационнойБазыПоУмолчанию - префикс по-умолчанию для ИБ "КУ"
//  * [Процедура]ПолучитьПланыОбмена - добавлен план обмена: ОбменВРаспределеннойИнформационнойБазе 
// 
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
