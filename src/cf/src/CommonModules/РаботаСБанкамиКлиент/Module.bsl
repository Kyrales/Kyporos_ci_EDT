...
//  * [Процедура]ПослеНачалаРаботыСистемы - ошибка типовой 1С: добавлена проверка на наличие подсистемы ИнтернетПоддержкаПользователей.РаботаСКлассификаторами
// 
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
