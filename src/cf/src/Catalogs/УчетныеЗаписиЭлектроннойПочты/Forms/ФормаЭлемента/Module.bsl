...
//  * [Процедура]ПриСозданииНаСервере - добавление на форме: ИспользоватьДляЗагрузкиВходящихЭлектронныхПисем. Включает в работу регламентные задания: ПолучениеЭлектронныхСообщений, ОбработкаЭлектронныхСообщений
//
// ТЕГИ ИЗМЕНЕНИЙ
//
//}} *Олег Каратаев <<<<<<<<<<<<<<<<<<<<<<< ОПИСАНИЕ ИЗМЕНЕНИЙ <<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Группа.Заголовок = "Дополнительные настройки";
	
	//Добавить поле
	ПолеВвода = Элементы.Добавить("ИспользоватьДляЗагрузкиВходящихЭлектронныхПисем", Тип("ПолеФормы"), Группа);
	ПолеВвода.Вид = ВидПоляФормы.ПолеФлажка;
	ПолеВвода.ПутьКДанным = "Объект.ИспользоватьДляЗагрузкиВходящихЭлектронныхПисем";
