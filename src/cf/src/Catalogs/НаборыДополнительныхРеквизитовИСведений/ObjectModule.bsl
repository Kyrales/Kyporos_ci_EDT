...
//  + [ПредопределенныйЭлемент]УдалитьЗадача_ЗадачиПользователя - это группа. Не актуально в новых версиях.
//  + [ПредопределенныйЭлемент]УдалитьСправочник_Номенклатура - это группа. Не актуально в новых версиях.
//  + [ПредопределенныйЭлемент]УдалитьСправочник_ПапкиФайлов - это элемент. Не актуально в новых версиях.
//  + [ПредопределенныйЭлемент]УдалитьСправочник_Файлы - это элемент. Не актуально в новых версиях.
//  + [ПредопределенныйЭлемент]УдалитьСправочник_Организации - это элемент. Не актуально в новых версиях.
//  + [ПредопределенныйЭлемент]УдалитьСправочник_РабочиеМеста - это элемент. Не актуально в новых версиях.
// 
